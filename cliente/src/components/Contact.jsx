...
const Contacto = () => {
  ...
  <div class="absolute inset-0 bg-blue-300" id='iframeContainer'>
     <iframe id='iframe' src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d19616.795515248163!2d-3.5194618144854872!3d40.42655732538545!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1ses!2ses!4v1654157929322!5m2!1ses!2ses" width="80%" height="80%" style={{border:0,marginTop:100,marginLeft:160,borderRadius:10}} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
     </div>
  <div class="container px-5 py-24 " style={{marginTop:15,marginRight:160}} id='formContainer'>
    <div class="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md" id='form'>
